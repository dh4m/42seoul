...
/*   Updated: 2023/03/01 14:40:33 by dham             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
*/
	...
	content->obj_list.next->color.b = 0;
	...
	content->obj_list.next->next->loc.x = 4.8;
	content->obj_list.next->next->loc.y = 1.5;
	content->obj_list.next->next->loc.z = -1;
	content->obj_list.next->next->color.r = 255;
	content->obj_list.next->next->color.g = 255;
	content->obj_list.next->next->color.b = 255;
	content->obj_list.next->next->diameter = 2;
